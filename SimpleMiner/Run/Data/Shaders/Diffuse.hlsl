...
float4 PixelMain(v2p_t input) : SV_Target0
{
    ...
    float4 outDoor = input.color.r / 15.f * OutdoorLightColor;
    float4 inDoor = input.color.g / 15.f * IndoorLightColor;
    float4 white = 1.f;
    float4 finalColor = white - (white - outDoor) * (white * inDoor);
