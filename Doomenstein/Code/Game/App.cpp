...
void App::Startup()
{
	...
	controls.push_back("G - Start Game");
	controls.push_back("LMB/RMB - Use Weapon:");
	controls.push_back("Melee: LMB to attack, Hold RMB to Block");
	controls.push_back("Meat: Hold and release LMB to throw, RMB to eat and heal");
	controls.push_back("1,2, L Arrow, R Arrow - Switch Weapons");
	controls.push_back("Q/E Zoom In/Out of Third Person Camera");
...
void App::Update()
{
	...
	if (!g_theWindow->HasFocus()
		...
		||g_theGame->m_currentState==GameState::ATTRACT) {
