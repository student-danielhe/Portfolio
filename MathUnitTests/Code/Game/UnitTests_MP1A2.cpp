...
//-----------------------------------------------------------------------------------------------
int TestSet_MP1A2_RandomNumberGenerator_Ints()
{
#if defined( ENABLE_TestSet_MP1A2_RandomNumberGenerator_Ints )
...
//-----------------------------------------------------------------------------------------------
int TestSet_MP1A2_RandomNumberGenerator_Floats()
{
#if defined( ENABLE_TestSet_MP1A2_RandomNumberGenerator_Floats )
...
void RunTests_MP1A2()
{
	...
	RunTestSet( true, TestSet_MP1A2_RandomNumberGenerator_Ints,		"MP1-A2: RandomNumberGenerator Int methods" );
	RunTestSet( true, TestSet_MP1A2_RandomNumberGenerator_Floats,	"MP1-A2: RandomNumberGenerator Float methods" );
