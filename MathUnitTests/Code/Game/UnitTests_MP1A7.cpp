...
// UnitTests_MP1A7.cpp
//
#include "Game/UnitTests_MP1A7.hpp"
#include <stdio.h>
#include <stdlib.h>
...
#if defined( ENABLE_TestSet_MP1A7_MatrixConstruction ) // Suppress these until Vec4 & Mat44 exist
//-----------------------------------------------------------------------------------------------
...
#endif // ENABLE_TestSet_MP1A7_MatrixConstruction
...
//-----------------------------------------------------------------------------------------------
int TestSet_MP1A7_MatrixConstruction()
{
#if defined( ENABLE_TestSet_MP1A7_MatrixConstruction )
...
//-----------------------------------------------------------------------------------------------
int TestSet_MP1A7_MatrixStaticCreates()
{
#if defined( ENABLE_TestSet_MP1A7_MatrixStaticCreates )
...
//-----------------------------------------------------------------------------------------------
int TestSet_MP1A7_MatrixAccessors()
{
#if defined( ENABLE_TestSet_MP1A7_MatrixAccessors )
...
//-----------------------------------------------------------------------------------------------
int TestSet_MP1A7_MatrixMutators()
{
#if defined( ENABLE_TestSet_MP1A7_MatrixMutators )
...
//-----------------------------------------------------------------------------------------------
int TestSet_MP1A7_MatrixAppends()
{
#if defined( ENABLE_TestSet_MP1A7_MatrixAppends )
...
//-----------------------------------------------------------------------------------------------
int TestSet_MP1A7_MatrixTransforms()
{
#if defined( ENABLE_TestSet_MP1A7_MatrixTransforms )
	...
	Vector4Class v4a = identity.Mat44_TransformHomogeneous3D( vector4D );
	Vector4Class p4a = identity.Mat44_TransformHomogeneous3D( position4D );
	...
	Vector4Class v4b = complexMatrix.Mat44_TransformHomogeneous3D( vector4D ); // Compile error?  Check your const-ness!
	Vector4Class p4b = complexMatrix.Mat44_TransformHomogeneous3D( position4D );
...
void RunTests_MP1A7()
{
	printf( "(MP1-A5 and MP1-A6 have no unit tests.)\n" );
	printf( "Running tests for MP1-A7 (version 1)...\n" );
	RunTestSet( true, TestSet_MP1A7_MatrixConstruction,		"MP1-A7: Matrix44 Construction" );
	RunTestSet( true, TestSet_MP1A7_MatrixStaticCreates,	"MP1-A7: Matrix44 Static Create methods" );
	RunTestSet( true, TestSet_MP1A7_MatrixAccessors,		"MP1-A7: Matrix44 Accessors (gets)" );
	RunTestSet( true, TestSet_MP1A7_MatrixMutators,			"MP1-A7: Matrix44 Mutators (sets)" );
	RunTestSet( true, TestSet_MP1A7_MatrixAppends,			"MP1-A7: Matrix44 Appends (self-transforms)" );
	RunTestSet( true, TestSet_MP1A7_MatrixTransforms,		"MP1-A7: Matrix44 Transform methods" );
}
