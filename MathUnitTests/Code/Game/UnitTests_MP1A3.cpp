...
int TestSet_MP1A3_LerpAndClamp()
{
	...
	// Range map
	VerifyTestResult( IsMostlyEqual( Function_RangeMapFloat( 12.f, 10.f, 20.f, 100.f, 200.f ), 120.f ), "RangeMap() incorrect for 12 in [10,20] -> 120 in [100,200]" );
	VerifyTestResult( IsMostlyEqual( Function_RangeMapFloat( 104.f, 100.f, 200.f, 800.f, 600.f ), 792.f ), "RangeMap() incorrect for 104 in [100,200] -> 792 in [800,600]" );
	VerifyTestResult( IsMostlyEqual( Function_RangeMapFloat( 4.4f, 5.5f, 2.2f, -100.55f, -100.22f ), -100.44f ), "RangeMap() incorrect for 4.4 in [5.5,2.2] -> -100.44 in [-100.55,-100.22]" );
	VerifyTestResult( IsMostlyEqual( Function_RangeMapFloat( 71.f, 50.f, 90.f, 22.f, 22.f ), 22.f ), "RangeMap() incorrect for 71 in [50,90] -> 22 in [22,22]" );
	VerifyTestResult( IsMostlyEqual( Function_RangeMapFloatClamped( 12.f, 10.f, 20.f, 100.f, 200.f ), 120.f ), "RangeMapClamped() incorrect for 12 in [10,20] -> 120 in [100,200]" );
	VerifyTestResult( IsMostlyEqual( Function_RangeMapFloatClamped( 3.f, 5.f, 15.f, 100.f, 200.f ), 100.f ), "RangeMapClamped() incorrect for 3 in [5,15] -> 100 in [100,200]" );
	VerifyTestResult( IsMostlyEqual( Function_RangeMapFloatClamped( 23.f, 5.f, 15.f, 100.f, 200.f ), 200.f ), "RangeMapClamped() incorrect for 23 in [5,15] -> 200 in [100,200]" );
	VerifyTestResult( IsMostlyEqual( Function_RangeMapFloatClamped( 90.f, 100.f, 200.f, 800.f, 600.f ), 800.f ), "RangeMapClamped() incorrect for 90 in [100,200] -> 800 in [800,600]" );
	VerifyTestResult( IsMostlyEqual( Function_RangeMapFloatClamped( 222.f, 100.f, 200.f, 800.f, 600.f ), 600.f ), "RangeMapClamped() incorrect for 222 in [100,200] -> 600 in [800,600]" );
...
#endif
	return 26; // Number of tests expected
}
