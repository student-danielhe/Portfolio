...
int TestSet_MP2A2_OrthoProjection()
{
	...
	Matrix44Class orthoIdentity		= Matrix44Class::Mat44_CreateOrthoProjection( -1.f, 1.f, -1.f, 1.f, 0.f, 1.f );		// Maps x[-1,1], y[-1,1], z[0,1] to NDC
	Matrix44Class orthoBottomLeft	= Matrix44Class::Mat44_CreateOrthoProjection( 0.f, 1600.f, 0.f, 900.f, 0.f, 10.f );	// Maps x[0,1600], y[0,900] z[0,10] to NDC
	Matrix44Class orthoRoaming		= Matrix44Class::Mat44_CreateOrthoProjection( 10.f, 30.f, 40.f, 50.f, 60.f, 90.f );	// Maps x[10,30], y[40,50], z[60,90] to NDC

	// Correct values for each ortho matrix, given in basis-major order (Ix,Iy,Iz,Iw, Jx,Jy,Jz,Jw, Kx,Ky,Kz,Kw, Tx,Ty,Tz,Tw)
